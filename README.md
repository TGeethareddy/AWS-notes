...
open EC2 instance and click on connect - SSH group - copy 3rd command (chmod) - paste in github
copy example command form ec2 and paste in moba
...
### step5 Deploy a Sample App (Test EKS)
